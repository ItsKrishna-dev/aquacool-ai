...
export default function App() {
  ...
  if (page === 'Environmental Forecast') content = <EnvironmentPage {...common} />;
  ...
  if (page === 'Settings') content = <SettingsPage {...common} theme={theme} toggleTheme={toggleTheme} />;
  return (
    <DashboardLayout page={page} onNavigate={setPage} theme={theme} toggleTheme={toggleTheme} facility={facility} onAutomate={simulation.runAutomation} running={simulation.running}>
      {content}
    </DashboardLayout>
  );
}
